...
export default function Cabecalho() {
    return (
        <CabecalhoDiv>
            ...
            <div class="menu">
                <div class="menu-item"><a href='http://localhost:3000/lancamentos'> Lançamento</a></div>
                <div class="menu-item"><a href='http://localhost:3000/produtos-femininos'> Feminino</a></div>
                <div class="menu-item"><a href='http://localhost:3000/produtos-masculinos'> Masculino</a></div>
                <div class="menu-item"><a href='http://localhost:3000/produtos-infantis'> Infantil</a></div>
            </div>
